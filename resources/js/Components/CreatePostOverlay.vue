<script setup>
    ...
    const getUploadedImage = (e) => {
        ...
        const extension = form.file.name.substring(form.file.name.lastIndexOf('.') + 1);

        console.log(extension);
        if (extension === 'png' || extension === 'jpg' || extension === 'jpeg') {
            isValidFile = true;
            console.log('valid ' + isValidFile);
        } else {
             isValidFile = false;
             console.log('Lỗi: ' + isValidFile);
             return;
        }
    ...
    <div id="OverlaySection" class="fixed z-50 top-0 left-0 w-full h-screen bg-[#000000] bg-opacity-60 p-3">
        ...
        <div class="max-w-6xl h-[calc(100%-100px)] mx-auto mt-10 bg-white rounded-xl">
            <div class="flex items-center justify-between w-full rounded-t-xl p-3 border-b border-b-gray-300">
                ...
                <div class="text-lg font-semibold">New real</div>
            ...
            <div class="w-full md:flex h-[calc(100%-55px)] rounded-xl overflow-auto">
                <div class="flex items-center bg-gray-100 w-full h-full overflow-hidden">
                    ...
                    <img v-if="fileDisplay && isValidFile === true" class="min-w-[400px] p-4 mx-auto" :src="fileDisplay" alt="">
                </div>

                <div id="TextAreaSection" class="max-w-[720px] w-full relative">
                    <div class="flex items-center justify-between p-3">
                        <div class="flex items-center">
                            <img class="rounded-full w-[38px]" src="https://picsum.photos/id/50/300/320" alt="">
                    ...
                    <div class="flex items-center justify-between border-b p-3">
                        <div class="text-lg font-extrabold text-gray-500">Advanced Setting</div>
                        <ChevronDown :size="27" />
                    </div>

                    <div class="text-gray-500 mt-3 p-3 text-sm">
                        Your reel will be shared with followers in their feeds and can be seen on your profile.
